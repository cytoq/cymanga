...
from .views import MangaListView, AddMangaView, MangaUpdateView, MangaDeleteView, manga_detail, delete_comment, edit_comment, add_comment, rate_manga
...
urlpatterns = [
    ...
    path('mangas/mangas/manga/<int:manga_id>/', manga_detail, name='manga_detail'),
